...
function starter_setup_theme()
{
    ...
    */
    ...
    if (! file_exists(INCLUDE_PATH . '/class-phpcalendario.php') ) {
        // File does not exist... return an error.
        return new WP_Error('class-calendario-missing', __('Verifica che la classe Calendario esista nella cartella', 'luissall'));
    } else {
        // File exists... require it.
        include_once INCLUDE_PATH . '/class-phpcalendario.php';
    }
}
