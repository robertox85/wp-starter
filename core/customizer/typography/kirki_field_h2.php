<?php 
	...
	Kirki::add_field(
		...
		array(
			'type'        => 'toggle',
			'settings'    => 'typography_h2_toggle_field',
			'section'     => 'typography_section_h2',
			'label'       => esc_attr__( 'Edit H2?', 'starter' ),
	...
	Kirki::add_field(
		...
		array(
			...
			'required'    => array(
				array(
					'setting'  => 'typography_h2_toggle_field',
					'operator' => '==',
					'value'    => true,
				),
			),
