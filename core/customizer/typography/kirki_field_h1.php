<?php 
	...
	Kirki::add_field(
		...
		array(
			'type'        => 'toggle',
			'settings'    => 'typography_h1_toggle_field',
			'section'     => 'typography_section_h1',
			'label'       => esc_attr__( 'Edit H1?', 'starter' ),
	...
	Kirki::add_field(
		...
		array(
			'type'        => 'typography',
			'settings'    => 'typography_h1_field',
			'section'     => 'typography_section_h1',
			'label'       => esc_attr__( 'H2 Typography', 'starter' ),
			'description' => esc_attr__( 'Select the main typography options for your site.', 'starter' ),
			'help'        => esc_attr__( 'The typography options you set here apply to all content on your site.', 'starter' ),
			'priority'    => 10,
			'choices' => [
			...
			'required'    => array(
				array(
					'setting'  => 'typography_h1_toggle_field',
					'operator' => '==',
					'value'    => true,
				),
			),
