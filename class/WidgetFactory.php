...
class WidgetFactory extends WP_Widget_Factory {
	/** @var Starter_Widget_Factory */
	...
	function register($widget_class, $params = null) {
		...
		if ( apply_filters( 'starter_should_register_widget_in_acfw_widget_factory', true, $widget_class, $params ) ){
			$this->widgets[$key] = new $widget_class($params);
		} else {
			do_action( 'starter_register_widget_in_acfw_widget_factory', $widget_class, $params );
		}
	}
