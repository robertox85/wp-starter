	...
	<div class="row equal">
		...
		?>
				...
				<?php elseif ( get_sub_field( 'background_type' ) == 'immagine' ) : ?>
					...
					<div class="box <?php echo $col ?> image my-3 my-lg-5 <?php echo get_sub_field( 'posizione_testo' ); ?> ">
				...
				<?php else : ?>
					<div class="box <?php echo $col ?> my-3 my-lg-5 ">
